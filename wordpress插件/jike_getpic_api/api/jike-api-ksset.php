...
class JikeApiKsSet extends JikeApiController
{
	...
	public function get_index()
	{
		...
		$data['title'] = $this->option_value('ks-title');
		...
		$setdate['indexClass'] =  $this->get_c_show('class',$this->option_value('ks-class-show'));
	...
	*/
	public function get_config()
	{
		...
		$data['xcxtitle'] = $this->option_value('ks-title');
		$data['wxewmTmage'] = $this->option_value('wxewm-image')['url'];
		$data['Vague'] = $this->option_value('ks-vague');
		$data['Insetid'] = $this->option_value('ks-insetid');
		$data['Banner'] = $this->option_value('ks-banner');
		$data['Rewarded'] = $this->option_value('ks-rewarded');
		return $this->return_success($data);
	}
	/**
	 * 获取外链配置
	*/
	...
	{
		$data['wlapp'] = $this->option_value('kspro-wlapp');
		return $this->return_success($data);
	}
}
